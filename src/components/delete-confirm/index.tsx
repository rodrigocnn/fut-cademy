...
import { openModalDelete } from '../../modules/categories/slice';
...
interface ModalProps {
  show: boolean;
  title: string;
  mutation: UseMutationResult<number, AxiosError<unknown, any>, void>;
}

export const DeleteConfirm = ({ show, title, mutation }: ModalProps) => {
            ...
            <div className="relative h-full w-full max-w-md p-4 md:h-auto">
              <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
                <div className="flex items-start justify-between rounded-t p-4 dark:border-gray-600">
                  ...
                  <button
                    onClick={() => dispatch(openModalDelete())}
                    type="button"
